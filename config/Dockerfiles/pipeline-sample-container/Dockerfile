...
RUN if [ "${ENABLE_VM}" == "true" ]; then echo "ENABLE_VM: true"; curl -o $HOME/images/latest-atomic.qcow2 ${VM_IMAGE_URL}; else echo "ENABLE_VM: false"; echo "NOT Pulling VM cloud image"; fi
